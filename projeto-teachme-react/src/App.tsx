...
function App() {
  ...
  async function handleSubmitChat() {
    ...
    if (progress === "pending") {
      ...
      const prompt = `gere uma pergunta onde simule uma entrevista de emprego sobre ${message},
      após gerar a pergunta, enviarei a resposta e você me dará um feedback.
